...
Note: two plots are included because displaying two types of numeric values that aren't a one-to-one transformation (in this case raw numbers and percentages) is not advised.
